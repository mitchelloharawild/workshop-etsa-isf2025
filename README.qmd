...
Session 1: Time series data, aggregations, time series patterns (via `autoplot()`), time series decomposition and features

Session 2: Calendrical visualisation with the grammar of time series graphics (season plots, subseries plots, calendar plots, ...)
